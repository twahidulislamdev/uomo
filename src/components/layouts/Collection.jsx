                ...
                <div className="p-5 absolute left-5 bottom-5 ">
                  ...
                  <Link to={"/shop"}>
                    <button className="relative px-0 py-2 text-black text-sm group hover:cursor-pointer  ">
                      ...
                      <span
                        className="absolute left-0 bottom-0  h-0.5 bg-black transform w-1/3 group-hover:w-full group-hover:left-0 group-hover:translate-x-0  transition-all duration-300 ease-in-out"
                      ></span>
                    </button>
                  </Link>
                </div>
